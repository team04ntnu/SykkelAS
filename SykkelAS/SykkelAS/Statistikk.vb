...
Public Class Statistikk
    ...
    Dim lønn, fasteUtgifter, variableUtgifter As Integer
    ...
    Private Sub btnBeregn_Click(sender As Object, e As EventArgs) Handles btnBeregn.Click
        ...
        Try
            ...
            ElseIf rbtnAvdeling.Checked = True Then
                ...
                Dim sql2 As New MySqlCommand("SELECT COUNT(*) FROM utleid_sykkel INNER JOIN leieavtale ON utleid_sykkel.leieavtale_nr = leieavtale.leieavtale_nr WHERE leieavtale.avdeling_nr = @nr AND leieavtale.tidspunkt_fra BETWEEN '@fra' AND '@til'", tilkobling)
            ...
            ElseIf rbtnAvanse.Checked = True Then
                ...
                Dim sql3 As New MySqlCommand("SELECT sykkel_id, COUNT(*) FROM utleid_sykkel INNER JOIN leieavtale ON utleid_sykkel.leieavtale_nr = leieavtale.leieavtale_nr WHERE leieavtale.avdeling_nr = @nr AND leieavtale.tidspunkt_fra BETWEEN '@fra' AND '@til' GROUP BY sykkel_id", tilkobling)
                sql3.Parameters.AddWithValue("@fra", fra)
                sql3.Parameters.AddWithValue("@til", til)
                sql3.Parameters.AddWithValue("@avdeling", nr)
